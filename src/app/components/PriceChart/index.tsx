...
//           i === chartData.length - 1 ? currentPrice : p,
//         ),
//         borderColor: currentPrice >= chartData[0] ? "#4ade80" : "#f87171",
...
//       title: {
//         display: true,
//         text: `Last 24h Price Chart (Updated: ${new Date().toLocaleTimeString()})`,
...
//   return (
//     <div className="flex h-full w-full flex-col overflow-hidden rounded-xl border border-gray-200 bg-white p-4 shadow-sm sm:rounded-none sm:border-0 sm:p-0 md:rounded-xl md:border md:p-4 dark:border-gray-700 dark:bg-gray-900">
//       <div className="min-h-[300px] flex-1 md:h-[40vh]">
